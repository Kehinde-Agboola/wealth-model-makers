        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {programHighlights.map((highlight, index) => (
              <Card key={index} className="overflow-hidden text-center shadow-elegant hover:shadow-hero transition-all duration-300 hover:-translate-y-1">
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-white rounded-full flex items-center justify-center text-primary">
                    {highlight.icon}
                  </div>
                </div>
                <CardHeader>
